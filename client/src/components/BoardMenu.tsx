...
const SHORTCUTS: { keys: string; action: string }[] = [
  ...
  { keys: "Drag data", action: "Pan slice" },
  { keys: "Wheel over data", action: "Step through slices" },
  { keys: "Ctrl + wheel over data", action: "Zoom slice" },
  { keys: "Click card", action: "Select" },
  { keys: "Shift + click card", action: "Add to selection" },
  { keys: "Drag board", action: "Select an area" },
  { keys: "Drag card label", action: "Move selection" },
  { keys: "Alt + drag card", action: "Move selection" },
